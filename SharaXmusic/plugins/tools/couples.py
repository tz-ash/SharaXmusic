...
#BOT FILE NAME
from SharaXmusic import app as app
from SharaXmusic.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𓊈𐏓𐏓꯭꯭ ⃪𝐃𝐚𝐧𝐠𝐞𝐫]❝ ⚡ 𝐙𝐨𝐧𝐞•๋๋๋๋๋๋๋๋๋๋๋𝆺꯭𝅥•๋๋๋๋๋๋๋๋๋๋๋𝆺꯭𝅥»𓊉",
            url=f"https://DANGER_X_ZONE",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "SharaXmusic/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "SharaXmusic/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("SharaXmusic/assets/cppic.png")
